...
void main(){
  runApp(MaterialApp(
      ...
      home: DevicePreview(enabled: true, builder: (context) => const ScreenNine())));
}
                      ...
                      children: [
                       ...
                       Column(
                         ...
                         children: [
                           ...
                           Text("Lihat semua transki jual dan beli",style: TextStyle(color: Colors.grey,fontSize: 12),)
                         ],
                       ),
                       SizedBox(
                         width: 80,
              ...
              children: [
                Row(
                  children: [
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Text("Produk",style: TextStyle(color: Colors.black,fontSize: 20,fontWeight: FontWeight.w600),),
                    ),
                  ],
                ),
                Container(
